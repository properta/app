...
use app\models\mains\generals\MCurrencies as MCurrenciesModel;

/**
 * MCurrencies represents the model behind the search form of `app\models\mains\generals\MCurrencies`.
 */
class MCurrencies extends MCurrenciesModel
{
    /**
     * {@inheritdoc}
     */
