...
use app\models\mains\generals\MMaterials as MMaterialsModel;

/**
 * MMaterials represents the model behind the search form of `app\models\mains\generals\MMaterials`.
 */
class MMaterials extends MMaterialsModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'default_unit_code_id', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by'], 'integer'],
