...
use app\models\mains\generals\WupaMasters as WupaMastersModel;

/**
 * WupaMasters represents the model behind the search form of `app\models\mains\generals\WupaMasters`.
 */
class WupaMasters extends WupaMastersModel
{
    /**
     * {@inheritdoc}
     */
