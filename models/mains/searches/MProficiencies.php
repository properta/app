...
use app\models\mains\generals\MProficiencies as MProficienciesModel;

/**
 * MProficiencies represents the model behind the search form of `app\models\mains\generals\MProficiencies`.
 */
class MProficiencies extends MProficienciesModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'default_unit_code_id', 'status', 'created_at', 'created_by', 'updated_at', 'deleted_at', 'deleted_by'], 'integer'],
    ...
    {
        $query = MProficienciesModel::find();
