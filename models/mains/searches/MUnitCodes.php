...
use app\models\mains\generals\MUnitCodes as MUnitCodesModel;

/**
 * MUnitCodes represents the model behind the search form of `app\models\mains\generals\MUnitCodes`.
 */
class MUnitCodes extends MUnitCodesModel
{
    /**
     * {@inheritdoc}
     */
