...
/**
 * This is the model class for table "m_wind_directions".
 *
 * @property int $id
 ...
 */
class MWindDirections extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(PlotOfLands::className(), ['wind_direction_id' => 'id']);
    }
