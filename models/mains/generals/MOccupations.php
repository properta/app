...
/**
 * This is the model class for table "m_occupations".
 *
 * @property int $id
 ...
 * @property int|null $proficiencie_id
 ...
 * @property MProficiencies $proficiencie
 * @property Users $updatedBy
 */
class MOccupations extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['code', 'title'], 'required'],
            [['level', 'proficiencie_id', 'default_unit_code_id', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by'], 'integer'],
            [['desc'], 'string'],
            [['code'], 'string', 'max' => 15],
            ...
            [['proficiencie_id'], 'exist', 'skipOnError' => true, 'targetClass' => MProficiencies::className(), 'targetAttribute' => ['proficiencie_id' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'desc' => Yii::t('app', 'Desc'),
            'proficiencie_id' => Yii::t('app', 'Proficiencie ID'),
    ...
    {
        return $this->hasMany(BpItems::className(), ['occupation_category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(BpItems::className(), ['occupation_item_id' => 'id']);
    }
    ...
    /**
     * Gets query for [[Proficiencie]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getProficiencie()
    {
        return $this->hasOne(MProficiencies::className(), ['id' => 'proficiencie_id']);
    }
