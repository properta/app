...
/**
 * This is the model class for table "m_proficiencies".
 *
 * @property int $id
 ...
 */
class MProficiencies extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['code', 'title'], 'required'],
            [['desc'], 'string'],
            [['default_unit_code_id', 'status', 'created_at', 'created_by', 'updated_at', 'deleted_at', 'deleted_by'], 'integer'],
            [['code'], 'string', 'max' => 15],
    ...
    {
        return $this->hasMany(MOccupations::className(), ['proficiencie_id' => 'id']);
    }
}