...
class Settings extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Markers::className(), ['marker_type_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(PlotDimensionTypes::className(), ['plot_type_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(PlotOfLands::className(), ['excess_desc_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(ProjectSettings::className(), ['setting_id' => 'id']);
    }
