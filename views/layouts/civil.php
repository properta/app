            ...
            <nav class="navbar navbar-expand-lg main-navbar" style="z-index:unset">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= Yii::$app->user->identity->image ?? Yii::$app->homeUrl . "theme/stisla/assets/img/avatar/avatar-1.png" ?>" class="rounded-circle profile-widget-picture mt-n3" style="width:32px; height:32px">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= \yii\helpers\Url::to('site/logout', true) ?>" data-method="post" class="dropdown-item has-icon text-danger">
