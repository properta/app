        ...
        <div class="card">
            ...
            <div class="card-body pb-4">
                ...
                <?php endif; ?> <div class="tw-block">
                    ...
                    ?>
                    <span class='tw-bg-red-400 tw-px-3 tw-py-1 tw-rounded-full tw-text-white tw-text-xs'><?= $level; ?></span>
                </div>
                ...
                <div class="tw-grid tw-space-y-3">
                    ...
                    <span>
                        <p class="tw-text-base tw-font-bold tw-mb-1">School</p>
                        <p class="tw-mb-0"><?= $model->school_str ?? "-"; ?></p>
                        <p><?= $model->school_address_str ?? "-" ?></p>
                    </span>
                </div>
            </div>
        </div>
