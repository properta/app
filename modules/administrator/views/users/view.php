            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-md table-striped">
                        <tr>
                            <td class="tw-font-bold"><?= $model->getAttributeLabel('username') ?></td>
                            <td>:</td>
                            <td><?= $model->username ?? "-" ?></td>
                        </tr>
                        <tr>
                            <td class="tw-font-bold"><?= $model->getAttributeLabel('full_name') ?></td>
                            <td>:</td>
                            <td><?= $model->full_name ?? "-" ?></td>
                        </tr>
                        <tr>
                            <td class="tw-font-bold"><?= $model->getAttributeLabel('email') ?></td>
                            <td>:</td>
                            <td><?= $model->email ?? "-" ?></td>
                        </tr>
                        <tr>
                            <td class="tw-font-bold"><?= $model->getAttributeLabel('phone') ?></td>
                            <td>:</td>
                            <td><?= $model->phone ?? "-" ?></td>
                        </tr>
                    </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-striped">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><?= $model->status == 10 ? "<span class='badge badge-primary'>Aktif</span>" : "<span class='badge badge-warning'>Tidak Aktif</span>" ?>
                                </td>
                            </tr>
                        </table>
                    </div>
