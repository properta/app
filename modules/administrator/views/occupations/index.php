...
$this->title = Yii::t('app', 'List of Occupations');
?>
<?php Pjax::begin(); ?>
...
<div class="index">
    <div class="row">
        <div class="col-12">
            <p>
                <?= Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Occupation'), ['create'], ['class' => 'btn btn-info m-1', 'id' => 'modalCreate']) ?>
            </p>
            <div class="card">
...
<?php
$this->registerJsVar('title', Yii::t('app', 'Add Occupation'));
$js = <<< JS
