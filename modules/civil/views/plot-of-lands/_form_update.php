        ...
        <div class="card">
            ...
            <div class="card-body col-8 m-auto">
                <div class="row">
                    ...
                    <div class="col-6">
                        <?= $form->field($model, 'marker_area_id')->dropDownList($dimension??[],['class' => 'form-control select2', 'id' => 'marker_area_id', 'prompt' => Yii::t('app', '--choose one--')]); ?>
                    </div>
                    <div class="col-6">
                        <?= $form->field($model, 'marker_area_str', Template::template('fas fa-flag'))->textInput(['maxlength' => true, 'placeholder' =>'']) ?>
                    </div>
                    <div class="col-6">
                        <?= $form->field($model, 'wind_direction_id')->dropDownList($dimension??[],['class' => 'form-control select2', 'id' => 'wind_direction_id', 'prompt' => Yii::t('app', '--choose one--')]); ?>
                    </div>
                    <div class="col-6">
                        <?= $form->field($model, 'marker_area_str', Template::template('fas fa-flag'))->textInput(['maxlength' => true, 'placeholder' =>'']) ?>
                    </div>
                    <div class="col-6">
                        <?= $form->field($model, 'excess_unit_code_id')->dropDownList($dimension??[],['class' => 'form-control select2', 'id' => 'excess_unit_code_id', 'prompt' => Yii::t('app', '--choose one--')]); ?>
                    </div>
                    <div class="col-6">
