        ...
        <div class="card">
            <div class="card-body">
                <div class="form">
                    ...
                    <?= $form->field($model, 'code', Template::template('fas fa-flag'))->textInput(['maxlength' => true, 'placeholder' => 'PKU001']) ?>

                    <?= $form->field($model, 'title', Template::template('fas fa-user'))->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Type PIC Here')])->label(Yii::t('app', 'Person In Charge')) ?>

                    <?= $form->field($model, 'desc', Template::template('fas fa-phone'))->textInput(['maxlength' => true, 'placeholder' => '+628 1234 1234 123']) ?>
